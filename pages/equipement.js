...
const PRODUCTS_FR = [
  ...
  },
  {
    ...
    prices: [
      { label: "SPS 150 — 1.5 HP — 21 CFM (800 entailles)",    amount: "2 099.99$" },
      { label: "SPS 300 — 3 HP — 45 CFM (1 500 entailles)",    amount: "3 199.99$" },
      { label: "SPS 500 — 5 HP — 71 CFM (3 000 entailles)",    amount: "4 499.99$" },
      { label: "SPS 750 — 7.5 HP — 113 CFM (6 000 entailles)", amount: "4 999.99$" },
      { label: "SPS 1000 — 10 HP — 142 CFM (8 000 entailles)", amount: "5 499.99$" },
    ],
...
const PRODUCTS_EN = [
  ...
  },
  {
    ...
    prices: [
      { label: "SPS 150 — 1.5 HP — 21 CFM (800 taps)",    amount: "$2,099.99" },
      { label: "SPS 300 — 3 HP — 45 CFM (1,500 taps)",    amount: "$3,199.99" },
      { label: "SPS 500 — 5 HP — 71 CFM (3,000 taps)",    amount: "$4,499.99" },
      { label: "SPS 750 — 7.5 HP — 113 CFM (6,000 taps)", amount: "$4,999.99" },
      { label: "SPS 1000 — 10 HP — 142 CFM (8,000 taps)", amount: "$5,499.99" },
    ],
